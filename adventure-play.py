...
def cave():
    ...
    mary("Don't leave,look under the ground there is a tunnel.\n"
         "it takes you to areas.")
...
def areas():
    mary("you ae under ground now ,are you ready?\n"
         "or not.if you are not ready stop")
    ...
    if turtle == "2":
        ...
        turnchoice = input("your choice 1 to finish or 2\n"
                           "1.yes\n" "2.no\n")
...
def start():
    mary("your achievmen many thing . go ahead" + areas)
